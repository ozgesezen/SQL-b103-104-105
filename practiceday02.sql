...
ON DELETE CASCADE --child tablo silinmeden parent yada child daki veriyi silmeden parent silinebilecek 
--fakat parentta veri silindiginde childda da silinecek
);
...
--on delete cascade sayesinde child silmeden parent silindi
delete from parent2;

--soru2: parent2 tablosunu silin
